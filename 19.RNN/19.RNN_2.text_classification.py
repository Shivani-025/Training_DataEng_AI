...
#----------------------OUTPUT------------------------
'''
Sorted List [' ', 'a', 'd', 'e', 'g', 'h', 'i', 'l', 'm', 'n', 'o', 'p', 'r', 's', 't', 'w', 'x']
Char:Idx  {' ': 0, 'a': 1, 'd': 2, 'e': 3, 'g': 4, 'h': 5, 'i': 6, 'l': 7, 'm': 8, 'n': 9, 'o': 10, 'p': 11, 'r': 12, 's': 13, 't': 14, 'w': 15, 'x': 16}  Idx:Char {0: ' ', 1: 'a', 2: 'd', 3: 'e', 4: 'g', 5: 'h', 6: 'i', 7: 'l', 8: 'm', 9: 'n', 10: 'o', 11: 'p', 12: 'r', 13: 's', 14: 't', 15: 'w', 16: 'x'}  
...
Generated text:
hello world this is a simple text generation example text generation example text generation example text
'''